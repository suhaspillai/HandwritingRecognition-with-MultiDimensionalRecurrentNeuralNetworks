...
setup(extensions =[Extension('cython_mul_check_3',['cython_mul_check_3.pyx'],extra_compile_args=["-g"],extra_link_args=["-g"])], ext_modules = cythonize(Extension('cython_mul_check_3',['cython_mul_check_3.pyx'],extra_compile_args=["-g"],extra_link_args=["-g"]),gdb_debug=True )
